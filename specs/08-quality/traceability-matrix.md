...
| GATE-E2E-001 (smoke-api) | `scripts/smoke-api.mjs` | sí | sí (7/7 local) | **PASS (local)** · **READY-BLOCKED (staging, Fase 8.1)** |
| GATE-DEPLOY-001 (Docker build api/web) | Dockerfiles + `.dockerignore` | sí (listos) | — | **BLOCKED (entorno)** · sigue BLOCKED en Fase 8.1 |
