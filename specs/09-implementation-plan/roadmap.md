...
| 8 | Release / CI / Deployment — **🟡 PARTIAL (8.2)** (rama pusheada + CI PASS + PR #1; **web v2 preview ✅** Vercel aislado READY; **API staging ⛔ READY-BLOCKED** por credenciales Railway) | 1–7 | N/A (release/operación) |
